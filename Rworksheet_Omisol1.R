...
numberVector <- c(34, 28, 22, 36, 27, 18, 52, 39, 42, 29, 35, 31, 27, 22, 37, 34, 19, 20, 57, 49, 50, 37, 46, 25, 17, 37, 42, 53, 41,51, 35, 24, 33, 41)
...
#Sort the values for age.Write the R code and its output.
...
#6
numberdata<- c(2.4,2.1,2.5,2.4,2.2,2.5,2.3,2.5,2.3,2.4,2.7)
num_data_points<-length(numberdata)
num_data_points



#7.
#Generates a new vector for data where you double every value of the data. | What happento the data?
...
#b.totalIntNum <- c(int1, numSeq, numMean, numSum)
#length(totalIntNum)
#[1] 143
...
#10
reversed_int <- (1:100)
sort(reversed_int, decreasing = T)
...
# Input your name: Carl Jason Omisol
age = readline(prompt="Input your age: ")
# Input your age: 20
print(paste("My name is",name, "and I am",age ,"years old."))
# Output: [1] "My name is Carl Jason Omisol and I am 20 years old."
